    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.warning_amber_rounded, color: warningColor, size: 20.r),
              SizedBox(width: 8.w),
              AutoSizeText(
                "COMMON MISTAKES",
                maxLines: 1,
            ...
            children: wrongCollocations.map((word) {
              return Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.close_rounded, color: warningColor, size: 12.r),
                    SizedBox(width: 4.w),
                    Text(
                      word,
                      style: TextStyle(
                        decoration: TextDecoration.lineThrough,
                        decorationColor: warningColor.withValues(alpha: 0.5),
                        fontFamily: 'Outfit',
                        fontSize: 12.sp,
