    ...
    return Center(
      child: Stack(
        ...
        children: [
          ...
          ).animate(target: isAnswered ? 1 : 0).scale(
            ...
            child: Column(
              children: [
                ...
                RichText(
                  ...
                  text: TextSpan(
                    children: _buildSentenceSpans(question, color, isDark),
                  ),
                )
        ...
        spans.add(TextSpan(
          ...
          style: TextStyle(fontFamily: 'Outfit', 
            ...
            color: isAnswered
                ...
                : color,
            decoration: isAnswered ? TextDecoration.none : TextDecoration.underline,
          ),
        ));
      }
    }
