            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  context.tr('settings_dialogs.sign_out_body'),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 14.sp,
                ...
                _PrimaryButton(
                  label: context.tr('settings_dialogs.sign_out_confirm'),
                  color: Colors.red,
                  onPressed: () {
                ...
                _SecondaryTextButton(
                  label: context.tr('settings_dialogs.sign_out_cancel'),
                  isDark: isDark,
          ...
          child: GlassTile(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  // FIX (HIGH-2): Was hardcoded English. Now localised.
                  context.tr('settings_dialogs.disable_notifications_body'),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 14.sp,
                ...
                SizedBox(height: 32.h),
                _PrimaryButton(
                  label: context.tr('settings_dialogs.keep_reminders'),
                  color: Colors.blue,
                  onPressed: () => Navigator.pop(dialogContext, false),
                ),
                SizedBox(height: 12.h),
                _DestructiveTextButton(
                  label: context.tr('settings_dialogs.yes_disable'),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  context.tr('settings_dialogs.disable_sound_title'),
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 24.sp,
                    fontWeight: FontWeight.w900,
                ...
                Text(
                  ...
                  context.tr('settings_dialogs.disable_sound_body'),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 14.sp,
                ...
                _PrimaryButton(
                  label: context.tr('settings_dialogs.keep_sound_on'),
                  color: Colors.blue,
                  onPressed: () => Navigator.pop(dialogContext, false),
                ),
                SizedBox(height: 12.h),
                _DestructiveTextButton(
                  label: context.tr('settings_dialogs.mute_anyway'),
                  onPressed: () => Navigator.pop(dialogContext, true),
                ),
              ],
            ),
          ...
          child: GlassTile(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 32.h),
                _PrimaryButton(
                  label: context.tr('settings_dialogs.send_link'),
                  color: Colors.blue,
                  onPressed: () {
          ...
          child: GlassTile(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 32.h),
                _PrimaryButton(
                  label: context.tr('settings_dialogs.delete_everything'),
                  color: Colors.red,
                  onPressed: () {
                    Navigator.pop(dialogContext);
                ...
                SizedBox(height: 12.h),
                _SecondaryTextButton(
                  label: context.tr('settings_dialogs.keep_account'),
                  isDark: isDark,
                  onPressed: () => Navigator.pop(dialogContext),
                ),
              ],
          ...
          child: GlassTile(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 24.h),
                Text(
                  title ?? context.tr('settings_dialogs.coming_soon_title'),
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 24.sp,
                    fontWeight: FontWeight.w900,
                ...
                SizedBox(height: 16.h),
                Text(
                  message ?? context.tr('settings_dialogs.coming_soon_body'),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 14.sp,
                ...
                _PrimaryButton(
                  ...
                  label: context.tr('settings_dialogs.got_it'),
                  color: Colors.blue,
                  onPressed: () => Navigator.pop(ctx),
                ),
              ],
    ...
    return GlassTile(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 32.h),
          _PrimaryButton(
            label: context.tr('settings_dialogs.delete_forever'),
            color: Colors.red,
          ...
          SizedBox(height: 12.h),
          _SecondaryTextButton(
            label: context.tr('settings_dialogs.nevermind'),
            isDark: isDark,
            onPressed: () => Navigator.pop(context),
          ),
        ],
