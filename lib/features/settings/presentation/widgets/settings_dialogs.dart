          ...
          child: GlassTile(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  context.tr('settings_dialogs.sign_out_title', fallback: 'Sign Out', fallback: 'Sign Out'),
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 24.sp,
                ...
                Text(
                  ...
                  context.tr('settings_dialogs.sign_out_body', fallback: 'Are you sure you want to sign out?', fallback: 'Are you sure you want to sign out?'),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 14.sp,
                ...
                _PrimaryButton(
                  label: context.tr('settings_dialogs.sign_out_confirm', fallback: 'Sign Out', fallback: 'Sign Out'),
                  color: Colors.red,
                  onPressed: () {
                ...
                _SecondaryTextButton(
                  label: context.tr('settings_dialogs.sign_out_cancel', fallback: 'Cancel', fallback: 'Cancel'),
                  isDark: isDark,
          ...
          child: GlassTile(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 24.h),
                Text(
                  context.tr('settings_dialogs.disable_notifications_title', fallback: 'Disable Notifications?', fallback: 'Disable Notifications?'),
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 24.sp,
                    fontWeight: FontWeight.w900,
                ...
                Text(
                  // FIX (HIGH-2): Was hardcoded English. Now localised.
                  context.tr('settings_dialogs.disable_notifications_body', fallback: 'You will miss out on daily reminders.', fallback: 'You will miss out on daily reminders.'),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 14.sp,
                ...
                SizedBox(height: 32.h),
                _PrimaryButton(
                  label: context.tr('settings_dialogs.keep_reminders', fallback: 'Keep Reminders', fallback: 'Keep Reminders'),
                  color: Colors.blue,
                  onPressed: () => Navigator.pop(dialogContext, false),
                ),
                SizedBox(height: 12.h),
                _DestructiveTextButton(
                  label: context.tr('settings_dialogs.yes_disable', fallback: 'Yes, Disable', fallback: 'Yes, Disable'),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  context.tr('settings_dialogs.disable_sound_title', fallback: 'Disable Sound?', fallback: 'Disable Sound?'),
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 24.sp,
                    fontWeight: FontWeight.w900,
                ...
                Text(
                  ...
                  context.tr('settings_dialogs.disable_sound_body', fallback: 'This will mute all game sounds.', fallback: 'This will mute all game sounds.'),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 14.sp,
                ...
                _PrimaryButton(
                  label: context.tr('settings_dialogs.keep_sound_on', fallback: 'Keep Sound On', fallback: 'Keep Sound On'),
                  color: Colors.blue,
                  onPressed: () => Navigator.pop(dialogContext, false),
                ),
                SizedBox(height: 12.h),
                _DestructiveTextButton(
                  label: context.tr('settings_dialogs.mute_anyway', fallback: 'Mute Anyway', fallback: 'Mute Anyway'),
                  onPressed: () => Navigator.pop(dialogContext, true),
                ),
              ],
            ),
          ...
          child: GlassTile(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 24.h),
                Text(
                  context.tr('settings_dialogs.reset_password_title', fallback: 'Reset Password', fallback: 'Reset Password'),
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 24.sp,
                    fontWeight: FontWeight.w900,
                ...
                SizedBox(height: 32.h),
                _PrimaryButton(
                  label: context.tr('settings_dialogs.send_link', fallback: 'Send Link', fallback: 'Send Link'),
                  color: Colors.blue,
                  onPressed: () {
                ...
                SizedBox(height: 12.h),
                _SecondaryTextButton(
                  label: context.tr('common.cancel', fallback: 'Cancel', fallback: 'Cancel'),
                  isDark: isDark,
          ...
          child: GlassTile(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 24.h),
                Text(
                  context.tr('settings_dialogs.delete_account_title', fallback: 'Delete Account', fallback: 'Delete Account'),
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 24.sp,
                    fontWeight: FontWeight.w900,
                ...
                SizedBox(height: 16.h),
                Text(
                  context.tr('settings_dialogs.delete_account_body', fallback: 'This action cannot be undone. All your progress will be lost.', fallback: 'This action cannot be undone. All your progress will be lost.'),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 14.sp,
                ...
                SizedBox(height: 32.h),
                _PrimaryButton(
                  label: context.tr('settings_dialogs.delete_everything', fallback: 'Delete Everything', fallback: 'Delete Everything'),
                  color: Colors.red,
                  onPressed: () {
                    Navigator.pop(dialogContext);
                ...
                SizedBox(height: 12.h),
                _SecondaryTextButton(
                  label: context.tr('settings_dialogs.keep_account', fallback: 'Keep Account', fallback: 'Keep Account'),
                  isDark: isDark,
                  onPressed: () => Navigator.pop(dialogContext),
                ),
              ],
          ...
          child: GlassTile(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 24.h),
                Text(
                  title ?? context.tr('settings_dialogs.coming_soon_title', fallback: 'Coming Soon!', fallback: 'Coming Soon!'),
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 24.sp,
                    fontWeight: FontWeight.w900,
                ...
                SizedBox(height: 16.h),
                Text(
                  message ?? context.tr('settings_dialogs.coming_soon_body', fallback: 'This feature is currently in development.', fallback: 'This feature is currently in development.'),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 14.sp,
                ...
                _PrimaryButton(
                  ...
                  label: context.tr('settings_dialogs.got_it', fallback: 'Got It', fallback: 'Got It'),
                  color: Colors.blue,
                  onPressed: () => Navigator.pop(ctx),
                ),
              ],
  ...
  Widget build(BuildContext context) {
    ...
    return GlassTile(
      ...
      child: Column(
        ...
        children: [
          Text(
            context.tr('settings_dialogs.profile_settings', fallback: 'Profile Settings', fallback: 'Profile Settings'),
            style: TextStyle(
              fontFamily: 'Outfit',
              fontSize: 24.sp,
              fontWeight: FontWeight.w900,
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: context.tr('settings_dialogs.display_name', fallback: 'Display Name', fallback: 'Display Name'),
            ...
            children: [
              Expanded(
                child: TextButton(
                  ...
                  child: Text(
                    context.tr('common.cancel', fallback: 'Cancel', fallback: 'Cancel'),
                    style: TextStyle(
                      fontFamily: 'Outfit',
                      color: isDark ? Colors.white38 : Colors.black38,
                    ),
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text(
                    context.tr('common.save', fallback: 'Save', fallback: 'Save'),
                    style: TextStyle(
                      fontFamily: 'Outfit',
                      fontWeight: FontWeight.w900,
                      fontSize: 16.sp,
  ...
  Widget build(BuildContext context) {
    ...
    return GlassTile(
      ...
      child: Column(
        ...
        children: [
          Text(
            context.tr('settings_dialogs.final_warning', fallback: 'Final Warning', fallback: 'Final Warning'),
            style: TextStyle(
              fontFamily: 'Outfit',
              fontSize: 24.sp,
              fontWeight: FontWeight.w900,
          ...
          SizedBox(height: 16.h),
          Text(
            context.tr('settings_dialogs.type_delete', fallback: 'Type DELETE to confirm', fallback: 'Type DELETE to confirm'),
            textAlign: TextAlign.center,
            style: TextStyle(
              fontFamily: 'Outfit',
              fontSize: 14.sp,
          ...
          SizedBox(height: 32.h),
          _PrimaryButton(
            label: context.tr('settings_dialogs.delete_forever', fallback: 'Delete Forever', fallback: 'Delete Forever'),
            color: Colors.red,
          ...
          SizedBox(height: 12.h),
          _SecondaryTextButton(
            label: context.tr('settings_dialogs.nevermind', fallback: 'Nevermind', fallback: 'Nevermind'),
            isDark: isDark,
            onPressed: () => Navigator.pop(context),
          ),
        ],
