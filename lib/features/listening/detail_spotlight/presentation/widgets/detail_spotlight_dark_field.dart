            ...
            return Stack(
              children: [
                ...
                GestureDetector(
                  ...
                  onPanUpdate: (details) {
                    double nextX = (pos.dx + details.delta.dx).clamp(
                      40.r,
                      constraints.maxWidth - 40.r,
                    );
                    double nextY = (pos.dy + details.delta.dy).clamp(
                      40.r,
                ...
                ...List.generate(options.length, (index) {
                  ...
                  double y = (index < 2)
                      ? 40.h
                      : (constraints.maxHeight - 120.h);

                  double dist =
                      (pos - Offset(x + tileW / 2, y + tileH / 2)).distance;
