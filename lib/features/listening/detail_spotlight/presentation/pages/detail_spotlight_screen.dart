    ...
    return Scaffold(
      ...
      body: BlocConsumer<ListeningBloc, ListeningState>(
        listener: (context, state) {
          ...
          description:
              'Your attention to detail is remarkable. Earned ${state.xpEarned} XP and ${state.coinsEarned} coins.',
        );
          } else if (state is ListeningGameOver) {
            GameDialogHelper.showGameOver(
        context,
        title: 'OUT OF FOCUS',
        description: 'The small details matter most. Ready to sharpen your focus?',
