    ...
    return Scaffold(
      ...
      body: BlocConsumer<ListeningBloc, ListeningState>(
        listener: (context, state) {
          ...
          description:
              'You have a natural gift for auditory context! Earned ${state.xpEarned} XP and ${state.coinsEarned} coins.',
        );
          } else if (state is ListeningGameOver) {
            GameDialogHelper.showGameOver(
        context,
        title: 'SIGNAL LOST',
        description: 'The background noise got the better of you. Ready to recalibrate?',
