    ...
    return Container(
          ...
          child: IntrinsicHeight(
            child: Row(
              ...
              children: [
                // Full-height teal indicator that stretches with content
                ExcludeSemantics(
                  child: Container(
                    width: 4.w,
                    decoration: BoxDecoration(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      // Word label row with pronunciation INLINE and confidence badge
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Expanded(
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 8.w),
                                    // Pronunciation button INLINE next to word
                                    Semantics(
                                      label:
                                          'Play pronunciation for ${label.label}',
                                      button: true,
                                      child: ScaleButton(
                                        onTap: () =>
                                            onPlayPronunciation(label.label),
                                        child: Container(
                      ...
                      // Definition + Grammar tip + Example
                      Container(
