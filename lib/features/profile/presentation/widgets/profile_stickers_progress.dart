      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      context.tr('profile.collection_progress', fallback: 'Collection Progress', fallback: 'Collection Progress'),
                      maxLines: 1,
              ...
              Semantics(
                button: true,
                label: context.tr('profile.view_all_stickers', fallback: 'View All Stickers', fallback: 'View All Stickers'),
                child: SizedBox(
                  height: 48.r,
                  child: Center(
                    child: ScaleButton(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          context.tr('profile.view_all', fallback: 'View All', fallback: 'View All'),
                          style: TextStyle(
                            fontFamily: 'Outfit',
                            fontSize: 11.sp,
                            fontWeight: FontWeight.w900,
          ...
          if (earnedStickers.isNotEmpty) ...[
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Semantics(
                    label: context.tr('profile.sticker_earned', fallback: 'Sticker Earned', fallback: 'Sticker Earned'),
                    child: Container(
            ...
            Text(
              context.tr('profile.start_collection_hint', fallback: 'Complete Kids quests to start collecting!', fallback: 'Complete Kids quests to start collecting!'),
              style: TextStyle(
                fontFamily: 'Outfit',
                fontSize: 12.sp,
