                ...
                child: SizedBox(
                  ...
                  child: Center(
                    child: Semantics(
                      button: true,
                      label: isPremium
                          ? context.tr('profile.edit_photo_premium')
                          : context.tr('profile.edit_photo'),
                      child: ScaleButton(
                        onTap: () {
              ...
              child: GlassTile(
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      child: Text(
                        user.displayName ?? context.tr('profile.default_name'),
                        maxLines: 1,
          ...
          child: Row(
            ...
            children: [
              if (isPremium) ...[
                ...
                SizedBox(width: 4.w),
                Text(
                  context.tr('profile.premium_member_badge'),
                  style: TextStyle(
                    fontFamily: 'Outfit',
                    fontSize: 12.sp,
                    color: const Color(0xFFF59E0B),
