...
class AdventureLevelScreen extends StatelessWidget {
  ...
  Widget _buildLevelPerks(BuildContext context, UserEntity user) {
    ...
    final perks = [
      {
        'title': context.tr('adventure.perk_streak_protection_title', fallback: 'Streak Protection', fallback: 'Streak Protection'),
        'desc': context.tr('adventure.perk_streak_protection_desc', fallback: 'Keep your streak alive even if you miss a day!', fallback: 'Keep your streak alive even if you miss a day!'),
        'level': 50,
      ...
      {
        'title': context.tr('adventure.perk_coin_multiplier_title', fallback: 'Coin Multiplier', fallback: 'Coin Multiplier'),
        'desc': context.tr('adventure.perk_coin_multiplier_desc', fallback: 'Earn bonus coins on every quest.', fallback: 'Earn bonus coins on every quest.'),
        'level': 100,
      ...
      {
        'title': context.tr('adventure.perk_avatar_aura_title', fallback: 'Avatar Aura', fallback: 'Avatar Aura'),
        'desc': context.tr('adventure.perk_avatar_aura_desc', fallback: 'Unlock a special glowing aura for your profile.', fallback: 'Unlock a special glowing aura for your profile.'),
        'level': 200,
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            context.tr('adventure.level_mastery_perks_header', fallback: 'Mastery Perks', fallback: 'Mastery Perks'),
            style: TextStyle(
              fontFamily: 'Outfit',
              fontSize: 12.sp,
              fontWeight: FontWeight.w900,
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            isActive
                                ? context.tr('adventure.perk_status_active', fallback: 'Active', fallback: 'Active')
                                : context.tr('adventure.perk_status_locked', fallback: 'Locked', fallback: 'Locked'),
                            style: TextStyle(
                              fontFamily: 'Outfit',
                              fontSize: 10.sp,
                              fontWeight: FontWeight.w900,
  ...
  Widget _buildMilestones(BuildContext context, UserEntity user) {
    ...
    return Column(
      ...
      children: [
        Text(
          context.tr('adventure.upcoming_milestones_header', fallback: 'Upcoming Milestones', fallback: 'Upcoming Milestones'),
          style: TextStyle(
            fontFamily: 'Outfit',
            fontSize: 12.sp,
            fontWeight: FontWeight.w900,
  ...
  void _purchaseHint(
    ...
    HintPurchaseDialog.show(
      ...
      titleBuilder: (amount) => amount > 5
          ? context.tr('adventure.hint_pack_grand_master', fallback: 'Grandmaster Hints', fallback: 'Grandmaster Hints')
          : context.tr('adventure.hint_pack_strategic', fallback: 'Strategic Hints', fallback: 'Strategic Hints'),
