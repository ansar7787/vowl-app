                  ...
                  sliver: SliverToBoxAdapter(
                    child: Column(
                      children: [
                        ...
                        _buildSectionTitle(
                          context.tr('profile.trophies_badges', fallback: 'Trophies & Badges', fallback: 'Trophies & Badges'),
                          isDark,
                          isMidnight,
                        ),
                      ...
                      if (badges.isEmpty) {
                        return SliverToBoxAdapter(
                          child: _buildEmptySection(
                            context.tr('profile.no_trophies', fallback: 'No trophies yet', fallback: 'No trophies yet'),
                            isDark,
                            isMidnight,
                  ...
                  sliver: SliverToBoxAdapter(
                    child: Column(
                      children: [
                        SizedBox(height: 48.h),
                        _buildSectionTitle(
                          context.tr('profile.collectibles_vault', fallback: 'Collectibles Vault', fallback: 'Collectibles Vault'),
                          isDark,
                          isMidnight,
                        ),
                        SizedBox(height: 20.h),
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              context.tr('profile.trophy_room', fallback: 'Trophy Room', fallback: 'Trophy Room'),
                              style: TextStyle(
                                fontFamily: 'Outfit',
                                fontSize: 26.sp,
                                fontWeight: FontWeight.w900,
                            ...
                            SizedBox(height: 8.h),
                            Text(
                              context.tr('profile.trophy_subtitle', fallback: 'Your achievements', fallback: 'Your achievements'),
                              style: TextStyle(
                                fontFamily: 'Outfit',
                                fontSize: 14.sp,
                                color: (isDark || isMidnight)
      ...
      builder: (context, state) {
        ...
        if (owned.isEmpty) {
          return _buildEmptySection(
            context.tr('profile.empty_vault', fallback: 'Your vault is empty.', fallback: 'Your vault is empty.'),
            isDark,
            isMidnight,
