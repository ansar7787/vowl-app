...
class TrophyRoomScreen extends StatelessWidget {
      ...
      body: Stack(
        children: [
          ...
          KidsBackgroundRenderer(
            ...
            primaryColor: isDark ? const Color(0xFFF59E0B) : const Color(0xFFFFD700),
            gameType: 'trophy',
          ),
  ...
  Widget _buildPremiumAppBar(BuildContext context, bool isDark, bool isMidnight) {
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      shape: BoxShape.circle,
                      boxShadow: [
                        BoxShadow(color: const Color(0xFFF59E0B).withValues(alpha: 0.4), blurRadius: 15, offset: const Offset(0, 6)),
                      ],
                    ),
                ...
                ...List.generate(3, (index) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      border: Border.all(
                        color: const Color(0xFFF59E0B).withValues(alpha: 0.15 - (index * 0.03)),
                        width: 2,
                      ),
                    ),
                ...
                Column(
                  ...
                  children: [
                    Stack(
                     ...
                     .moveY(begin: -10, end: 10, duration: 2.5.seconds, curve: Curves.easeInOutSine),
                    SizedBox(height: 20.h),
                    ...
                    ).animate().fadeIn(delay: 400.ms).slideY(begin: 0.2, curve: Curves.easeOutBack),
                  ],
                ),
              ],
            ),
  ...
  Widget _buildBadgeCard(String badgeId, bool isDark, bool isMidnight, int index) {
    ...
    final isLegendary = badgeId.contains('master') || badgeId.contains('legend') || badgeId.contains('100');
            ...
            children: [
              Container(
                ...
                child: Center(
                  child: Text(
                    isLegendary ? "👑" : "🏆",
                    style: TextStyle(fontSize: 32.sp, shadows: const [
      ...
      builder: (context, state) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final category = fId.contains('bed') ? 'bed' : (fId.contains('window') ? 'window' : 'prop');
                  ...
                  child: Stack(
                    ...
                    children: [
                      Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text(emoji, style: TextStyle(fontSize: 54.sp)).animate(onPlay: (c) => c.repeat(reverse: true)).moveY(begin: -3, end: 3, duration: 2.seconds),
                          SizedBox(height: 16.h),
                          Text(
                            name,
                            style: TextStyle(fontFamily: 'Outfit', 
            ...
            ).animate().scale(delay: (index * 50).ms, duration: 400.ms, curve: Curves.easeOutBack).fadeIn();
          },
        );
      },
    );
