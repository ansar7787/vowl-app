...
class _ConditionalsScreenState extends State<ConditionalsScreen> {
          ...
          child: quest == null
              ...
              : LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    final double estimatedContentHeight = (isCompact ? 30.h : 40.h) + (isCompact ? 70.h : 100.h) + (_isAnswered ? (isCompact ? 50.h : 90.h) : 0) + 40.h;
                        ...
                        isCompact
                            ? SizedBox(
                                ...
                                child: FittedBox(
                                  ...
                                  child: ConditionalsInstruction(primaryColor: theme.primaryColor),
                                ),
                              )
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: isCompact ? 6.h : 12.h),
                                Text(
                                  quest.question ?? "",
  ...
  Widget _buildChainArena(
    ...
    return LayoutBuilder(builder: (context, constraints) {
      final startPoint = Offset(constraints.maxWidth / 2, isCompact ? 10.h : 20.h);
      final double verticalSpace = (constraints.maxHeight - (isCompact ? 60.h : 120.h)).clamp(50.0, 450.0);
      final nodePoints = List.generate(options.length, (i) {
        return Offset(
          constraints.maxWidth / 2,
          (isCompact ? 40.h : 80.h) + (i * verticalSpace / (options.length - 1)),
        );
      });
      ...
      return GestureDetector(
        onPanUpdate: (details) {
          ...
          for (int i = 0; i < nodePoints.length; i++) {
            if ((details.localPosition - nodePoints[i]).distance < (isCompact ? 40.r : 60.r)) {
