    ...
    return Scaffold(
      ...
      body: BlocConsumer<RoleplayBloc, RoleplayState>(
        listener: (context, state) {
          ...
          description:
              'You earned ${state.xpEarned} XP and ${state.coinsEarned} Coins for your social grace!',
        ),
            );
        ...
        description: 'The conversation came to an abrupt halt. Recharge and try again!',
      );
