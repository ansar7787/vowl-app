...
class TravelDeskPassportBook extends StatelessWidget {
  ...
  Widget _buildDragTargetPage(int index, String text) {
    ...
    if (isHovered && !isAnswered) {
      ...
      borderColor = (isCorrect ?? false) ? Colors.greenAccent : Colors.redAccent;
    }
        ...
        return AnimatedContainer(
            ...
            boxShadow: [
              BoxShadow(
                color: (isSelected || isHovered)
                    ? (isSelected
                        ? ((isCorrect ?? false) ? Colors.greenAccent : Colors.redAccent)
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned.fill(
                child: CustomPaint(
                  painter: PassportBackgroundGrid(color: color.withValues(alpha: 0.04)),
                ),
              ),
                    ...
                    builder: (context, child) {
                      return CustomPaint(
                        painter: StampRipplePainter(
                          ...
                          themeColor: (isCorrect ?? false) ? Colors.greenAccent : Colors.redAccent,
                        ),
                      );
                    },
                  ),
