    ...
    return Scaffold(
      ...
      body: BlocConsumer<RoleplayBloc, RoleplayState>(
        listener: (context, state) {
          ...
          title: 'Calm Hero!',
          description:
              'You earned ${state.xpEarned} XP and ${state.coinsEarned} Coins. You save lives with clear words!',
        ),
            );
        ...
        description: 'Help couldn\t be sent because the report was unclear. Try again!',
      );
