        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(30.r),
              border: Border.all(
                color: isGolden ? Colors.white : Colors.white.withValues(alpha: 0.5), 
                width: 3.w
              ),
            ),
            child: Center(
              child: Row(
                ...
                children: [
                  if (icon != null) ...[
                    Icon(icon, color: textColor ?? (isGolden ? const Color(0xFF8B4513) : Colors.white), size: 26.sp),
                    SizedBox(width: 8.w),
                  ],
                  Flexible(
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: textColor ?? (isGolden ? const Color(0xFF8B4513) : Colors.white),
                        fontSize: 18.sp,
                        letterSpacing: 1.5,
                      ),
                      maxLines: 1,
