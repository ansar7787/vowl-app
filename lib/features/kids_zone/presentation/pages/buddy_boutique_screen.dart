              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        context.tr('games.kids_coins', fallback: 'Kids Coins', fallback: 'Kids Coins'),
                        style: TextStyle(
                          fontFamily: 'Outfit',
                          fontSize: 10.sp,
                          fontWeight: FontWeight.w900,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            context.tr('games.watch_and_earn', fallback: 'Watch & Earn', fallback: 'Watch & Earn'),
                            style: TextStyle(
                              fontFamily: 'Outfit',
                              fontSize: 10.sp,
                              fontWeight: FontWeight.w900,
                          ...
                          Text(
                            context.tr('games.get_10_coins', fallback: 'Get 10 Coins', fallback: 'Get 10 Coins'),
                            style: TextStyle(
                              fontFamily: 'Outfit',
                              fontSize: 18.sp,
                              fontWeight: FontWeight.w800,
