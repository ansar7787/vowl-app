...
class PronunciationFocusExplanationCard extends StatelessWidget {
  final GameQuest quest;
  final bool isCorrect;
  final bool isDark;

  const PronunciationFocusExplanationCard({
    super.key,
    required this.quest,
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: 8.w),
              Text(
                isCorrect ? "Critical Mass Achieved!" : "Phonetic Synthesis Failed",
