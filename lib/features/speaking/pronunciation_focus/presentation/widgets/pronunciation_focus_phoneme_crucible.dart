    ...
    return GlassTile(
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.lerp(const Color(0xFF1F1C2C), const Color(0xFFFF512F), heatLevel)!,
                  Color.lerp(const Color(0xFF928DAB), const Color(0xFFDD2476), heatLevel)!,
                ],
              ),
              borderRadius: BorderRadius.circular(24.r),
              boxShadow: [
                BoxShadow(
                  color: Color.lerp(Colors.blue, Colors.orangeAccent, heatLevel)!
          ...
          ).animate(onPlay: (c) => c.repeat(reverse: true)).slideY(begin: -0.05, end: 0.05, duration: const Duration(milliseconds: 1500)),
          ...
          AnimatedCrossFade(
            ...
            crossFadeState: showGuide ? CrossFadeState.showSecond : CrossFadeState.showFirst,
