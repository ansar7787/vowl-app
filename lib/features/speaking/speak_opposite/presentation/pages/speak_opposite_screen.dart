    ...
    return Scaffold(
      ...
      body: BlocConsumer<SpeakingBloc, SpeakingState>(
        listener: (context, state) {
          ...
          title: 'Antonym Ace!',
          description:
              'You earned ${state.xpEarned} XP and ${state.coinsEarned} Coins for knowing your opposites!',
        ),
            );
        ...
        description: 'Your antonym library is currently empty. Recharge and try again!',
      );
          }
        },
