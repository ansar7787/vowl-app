      ...
      children: [
        Expanded(
          child: _buildMiniStatTile(
            context,
            context.tr('home.streak', fallback: 'Streak', fallback: 'Streak'),
            '${user.currentStreak}',
        ...
        Expanded(
          child: _buildMiniStatTile(
            context,
            context.tr('home.coins', fallback: 'Coins', fallback: 'Coins'),
            '${user.coins}',
            Icons.paid_rounded,
        ...
        Expanded(
          child: _buildMiniStatTile(
            context,
            context.tr('home.kids', fallback: 'Kids', fallback: 'Kids'),
            '${user.kidsCoins}',
