...
class MasteryAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Progress is rendered visually by the ring below; expose it as a single
    // accessible value so screen readers announce it once instead of
    // narrating the decorative ring + avatar separately.
    final progressPercent = (progress.clamp(0.0, 1.0) * 100).round();

    return Semantics(
      label: context.tr(
        'home.avatar_progress_label',
        fallback: 'Avatar Progress',
