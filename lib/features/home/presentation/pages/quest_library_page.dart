...
class _QuestLibraryPageState extends State<QuestLibraryPage> {
                  ...
                  children: [
                    Expanded(
                      child: _buildStatMini(
                        ...
                        context.tr('quest_archive.xp_power'),
                        '${clearedLevels * 10} ${context.tr('common.xp_suffix')}',
                        const Color(0xFF3B82F6),
                        isDark,
                      ),
                    ),
                    Expanded(
                      child: Center(
                        child: _buildStatMini(
                          Icons.auto_stories_rounded,
                          context.tr('quest_archive.quests'),
                          "${_allSubtypes.length}",
                          const Color(0xFF3B82F6),
                          isDark,
                        ),
                    ...
                    Expanded(
                      child: Align(
                        ...
                        child: _buildStatMini(
                          Icons.stars_rounded,
                          context.tr('quest_archive.status'),
  ...
  Widget _buildLibraryQuestCard(
    ...
    return Semantics(
      button: true,
      label:
          '${theme.title}, ${context.tr('quest_archive.completed', args: [completedPercent.toString()])}',
      child: RepaintBoundary(
        child: ScaleButton(
          onTap: () => context.push(
