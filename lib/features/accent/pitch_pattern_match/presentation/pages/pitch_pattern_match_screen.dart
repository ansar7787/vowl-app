                            ...
                            children: [
                              ...
                              isCompact 
                                ? SizedBox(
                                    ...
                                    child: FittedBox(
                                      ...
                                      child: PitchPatternMatchInstruction(color: theme.primaryColor),
                                    ),
                                  )
                                : PitchPatternMatchInstruction(color: theme.primaryColor),
                              ...
                              isCompact 
                                ? SizedBox(
                                    ...
                                    child: FittedBox(
                                      fit: BoxFit.scaleDown,
                                      child: PitchPatternMatchPromptCard(
                                        word: quest.word ?? "",
                              ...
                              isCompact
                                ? SizedBox(
                                    ...
                                    child: FittedBox(
                                      fit: BoxFit.scaleDown,
                                      child: PitchPatternMatchMelodicCanvas(
                                        pattern: pattern,
                                        color: theme.primaryColor,
                                        isDark: isDark,
                              ...
                              isCompact
                                ? SizedBox(
                                    ...
                                    child: FittedBox(
                                      fit: BoxFit.scaleDown,
                                      child: PitchPatternMatchPulseSpeaker(
                            ...
                            children: [
                              ...
                              isCompact
                                ? SizedBox(
                                    ...
                                    child: FittedBox(
                                      fit: BoxFit.scaleDown,
                                      child: PitchPatternMatchSpectralSlider(
                                        options: options,
                              ...
                              if (_isAnswered) ...[
                                ...
                                isCompact
                                  ? SizedBox(
                                      ...
                                      child: FittedBox(
                                        fit: BoxFit.scaleDown,
                                        child: PitchPatternMatchExplanationCard(
                                          quest: quest,
                                          color: theme.primaryColor,
                                          isDark: isDark,
