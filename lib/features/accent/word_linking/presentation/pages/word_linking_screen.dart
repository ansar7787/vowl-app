                            ...
                            children: [
                              ...
                              isCompact 
                                ? SizedBox(
                                    ...
                                    child: FittedBox(
                                      ...
                                      child: WordLinkingInstruction(color: theme.primaryColor),
                                    ),
                                  )
                              ...
                              isCompact 
                                ? SizedBox(
                                    ...
                                    child: FittedBox(
                                      fit: BoxFit.scaleDown,
                                      child: WordLinkingPromptCard(color: theme.primaryColor, isDark: isDark),
                                    ),
                                  )
                              ...
                              if (_isAnswered) ...[
                                ...
                                isCompact
                                  ? SizedBox(
                                      ...
                                      child: FittedBox(
                                        fit: BoxFit.scaleDown,
                                        child: WordLinkingExplanationCard(
                                          quest: quest,
                                          color: theme.primaryColor,
                                          isDark: isDark,
