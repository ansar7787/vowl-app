                            ...
                            children: [
                              ...
                              isCompact 
                                ? SizedBox(
                                    ...
                                    child: FittedBox(
                                      ...
                                      child: IntonationMimicInstruction(color: theme.primaryColor),
                                    ),
                                  )
                              ...
                              isCompact
                                ? SizedBox(
                                    ...
                                    child: FittedBox(
                                      fit: BoxFit.scaleDown,
                                      child: IntonationMimicRollercoaster(
                                        contour: contour,
                                        color: theme.primaryColor,
                                        isDark: isDark,
                                        isRiding: _isRiding,
                              ...
                              isCompact
                                ? SizedBox(
                                    ...
                                    child: FittedBox(
                                      fit: BoxFit.scaleDown,
                                      child: IntonationMimicPulseSpeaker(
                            ...
                            children: [
                              ...
                              isCompact
                                ? SizedBox(
                                    ...
                                    child: FittedBox(
                                      fit: BoxFit.scaleDown,
                                      child: IntonationMimicSpectralSlider(
                                        options: options,
                              ...
                              if (_isAnswered) ...[
                                ...
                                isCompact
                                  ? SizedBox(
                                      ...
                                      child: FittedBox(
                                        fit: BoxFit.scaleDown,
                                        child: IntonationMimicExplanationCard(
                                          quest: quest,
                                          color: theme.primaryColor,
                                          isDark: isDark,
                                          isCorrect: _isCorrect,
