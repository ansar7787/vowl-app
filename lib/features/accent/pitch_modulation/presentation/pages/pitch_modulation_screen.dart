...
class _PitchModulationScreenState extends State<PitchModulationScreen> {
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildModulationDial(options, quest.correctAnswerIndex ?? 0, theme.primaryColor, isDark),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(width: 12.w),
          Text("IDENTIFY PITCH MODULATION CONTOUR & EMOTIONAL NUANCE", style: GoogleFonts.outfit(fontSize: 10.sp, fontWeight: FontWeight.w900, color: color, letterSpacing: 1.5)),
        ],
      ),
    );
  }
  ...
  Widget _buildModulationDial(List<String> options, int correct, Color color, bool isDark) {
    return Column(
      children: [
        Row(
        ...
        SizedBox(height: 24.h),
        Text(
          _isDragging ? "MODULATING TONE..." : "ROTATE DIAL OR TAP PREFERENCE", 
          style: GoogleFonts.shareTechMono(
            fontSize: 10.sp, 
            fontWeight: FontWeight.bold, 
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            correct ? "CORRECT INFLECTION!" : "INCORRECT INFLECTION",
            style: GoogleFonts.outfit(
              fontSize: 15.sp,
              fontWeight: FontWeight.w900,
              color: displayColor,
