...
class ConsonantClaritySpectralSlider extends StatelessWidget {
  ...
  const ConsonantClaritySpectralSlider({
    super.key,
    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            _buildConsonantOrb(options[0], 0, correctIndex, color, isDark),
            _buildConsonantOrb(options[1], 1, correctIndex, color, isDark),
          ],
        ),
