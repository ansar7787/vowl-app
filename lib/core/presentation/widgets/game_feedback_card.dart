          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                if (showEducationalInfo && ruleContent != null && ruleContent!.isNotEmpty) ...[
                ...
                if (showEducationalInfo && explanation != null && explanation!.isNotEmpty) ...[
                  SizedBox(height: 16.h),
                  _ExplanationCard(
                ...
                if (showEducationalInfo && sampleAnswer != null && sampleAnswer!.isNotEmpty) ...[
                  SizedBox(height: 16.h),
                  PedagogicalRuleBox(
                ...
                if (showEducationalInfo && requiredPoints != null && requiredPoints!.isNotEmpty) ...[
                  SizedBox(height: 16.h),
                  PedagogicalRuleBox(
                ...
                if (onTutorPass != null && isFinalFailure) ...[
                  ...
                  ScaleButton(
                    onTap: onTutorPass,
                    child: Text(
                      context.tr('games.pass_to_tutor', fallback: 'Pass to Tutor'),
                      style: TextStyle(
                        fontFamily: 'Outfit',
                        fontSize: 14.sp,
