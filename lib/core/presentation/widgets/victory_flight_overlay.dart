...
/// A premium, highly-kinetic full-screen cinematic overlay presenting Owly the mascot
/// flying across the screen on level victory, optimized with repaint boundaries and mount guards.
...
class _VictoryFlightOverlayState extends State<VictoryFlightOverlay> {
  // Seeded Random instance to ensure beautiful, balanced, and consistent starry sparkle layouts
  ...
  Widget _buildSparkle(int index) {
    ...
    return Positioned(
      left: -50,
      top: (250 + _random.nextInt(200)).h,
      child: Text(
        index % 2 == 0 ? '✨' : '⭐',
        style: TextStyle(fontSize: (10 + _random.nextInt(15)).sp),
      )
      .animate()
      .moveX(
        begin: 0,
