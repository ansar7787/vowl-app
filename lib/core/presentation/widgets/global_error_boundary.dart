...
class _FullErrorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      label: context.tr('error.system_anomaly', fallback: 'System Anomaly Detected', fallback: 'System Anomaly Detected'),
      child: Scaffold(
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        context.tr('error.system_anomaly', fallback: 'System Anomaly Detected', fallback: 'System Anomaly Detected'),
                        style: TextStyle(
                          fontFamily: 'Outfit',
                          fontSize: 24.sp,
                      ...
                      SizedBox(height: 16.h),
                      Text(
                        context.tr('error.system_anomaly_description', fallback: 'Our systems encountered an unexpected error.', fallback: 'Our systems encountered an unexpected error.'),
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontFamily: 'Outfit',
                          fontSize: 16.sp,
                      ...
                      Semantics(
                        button: true,
                        label: context.tr('error.return_to_base', fallback: 'Return to Base', fallback: 'Return to Base'),
                        child: ScaleButton(
                          onTap: onRetry,
                          child: Container(
                            ...
                            child: Text(
                              context.tr('error.return_to_base', fallback: 'Return to Base', fallback: 'Return to Base'),
                              style: TextStyle(
                                fontFamily: 'Outfit',
                                color: Colors.white,
                                fontWeight: FontWeight.w900,
