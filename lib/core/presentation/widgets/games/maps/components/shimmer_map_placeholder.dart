...
class ShimmerMapPlaceholder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Defensive: this widget is a reusable shared component, so don't trust
    // that every future caller will keep `points` and `totalLevels` in
    // perfect sync — index out of `points` safely instead of risking a
    // RangeError if they ever drift apart.
    final renderedLevelCount = totalLevels.clamp(0, points.length);
      ...
      children: [
        ...
        Column(
          children: [
            ...
            ...List.generate(renderedLevelCount, (index) {
