...
class StoryServiceImpl implements StoryService {
  ...
  static const Map<String, List<String>> legacyAdultScripts = {
    ...
    'audiomultiplechoice': [
      "",
      "Great start! You're getting the hang of picking out exactly what they're saying.",
      "Nice work! Your ears are getting much sharper at catching every detail.",
      "Halfway to 100! You're processing spoken English without even thinking about it.",
    ...
    'sentencebuilder': [
      ...
      "Great start! You're really getting a feel for how native speakers put words together.",
      "Look at you go! Your sentences are flowing much more naturally now.",
      "Halfway to 100! You're building sentences with true confidence and rhythm.",
      "100 levels beat! You can construct complex sentences without even thinking about it.",
      "Level 200 reached! Your instinct for English syntax is completely native. Amazing work!",
    ],
    'shortanswerwriting': [
      "",
