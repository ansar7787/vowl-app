...
class CacheException extends AppException {
  const CacheException([String? message, String? code, dynamic details])
    : super(message: message ?? 'CacheException', code: code, details: details);
}
...
class AuthException extends AppException {
  const AuthException([String? message, String? code, dynamic details])
    : super(message: message ?? 'AuthException', code: code, details: details);
}
...
class SpeechException extends AppException {
  const SpeechException([String? message, String? code, dynamic details])
    : super(
...
class AdException extends AppException {
  const AdException([String? message, String? code, dynamic details])
    : super(message: message ?? 'AdException', code: code, details: details);
}
...
class AudioException extends AppException {
  const AudioException([String? message, String? code, dynamic details])
    : super(message: message ?? 'AudioException', code: code, details: details);
}
