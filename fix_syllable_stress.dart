...
void main() {
  final file = File('lib/features/accent/syllable_stress/presentation/pages/syllable_stress_screen.dart');
  ...
  content = content.replaceAll('''                                                              instruction:
                                                                  _isFirstStagePassed''', '''                                                              instruction:
                                                                  _isFirstStagePassed.value''');

  content = content.replaceAll('''                                                    instruction: _isFirstStagePassed''', '''                                                    instruction: _isFirstStagePassed.value''');


  content = content.replaceAll('''                                                          isAnswered: _isAnswered || _isFirstStagePassed,
                                                          selectedIndex: _selectedIndex,''', '''                                                          isAnswered: _isAnswered.value || _isFirstStagePassed.value,
  ...
  content = content.replaceAll('''                                SizedBox(height: _isAnswered ? 180.h : 0),''', '''                                SizedBox(height: _isAnswered.value ? 180.h : 0),''');
