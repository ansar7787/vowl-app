...
function generate600PrefixSuffixQuests() {
    ...
    for (let i = 0; i < 600; i++) {
        ...
        const quest = {
            ...
            interactionType: "tree", // FIXED: Correctly identifies the Botanical Tree UI
            rootWord: data.root,
...
for (let b = 1; b <= 20; b++) {
  ...
  const end = b * 10;
  const fileName = `c:/Users/asus/Documents/App Projects/vowl/assets/curriculum/vocabulary/prefixSuffix_${start}_${end}.json`;
...
console.log("PREFIX SUFFIX TREE READY: 600 unique 'tree' interaction quests created.");
