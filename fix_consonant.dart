...
void main() {
  final file = File('lib/features/accent/consonant_clarity/presentation/pages/consonant_clarity_screen.dart');
  ...
  content = content.replaceAll('''                                                if (_isFirstStagePassed && quest.voicing != null && quest.airflow != null)''', '''                                                if (_isFirstStagePassed.value && quest.voicing != null && quest.airflow != null)''');
