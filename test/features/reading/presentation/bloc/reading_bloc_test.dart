...
void main() {
  ...
  late MockGetReadingQuest mockGetQuest;
  ...
  const tGameType = GameSubtype.readAndAnswer;
  const tLevel = 1;
  const tQuests = [
    ReadingQuest(id: '1', instruction: 'i1', difficulty: 1),
    ReadingQuest(id: '2', instruction: 'i2', difficulty: 1),
    ReadingQuest(id: '3', instruction: 'i3', difficulty: 1),
  ];

  group('FetchReadingQuests', () {
  ...
  group('SubmitAnswer', () {
    final tLoadedState = ReadingLoaded(
      quests: tQuests,
      currentIndex: 0,
      livesRemaining: 3,
    );
