...
void main() {
  ...
  group('GlassTile Widget Tests', () {
    testWidgets('should render child correctly', (WidgetTester tester) async {
      await tester.pumpWidget(
        createWidgetForTesting(
          child: const GlassTile(child: Text('Test Child')),
        ),
      );
    ...
    testWidgets('should apply provided borderRadius', (
      WidgetTester tester,
    ) async {
      final borderRadius = BorderRadius.circular(16);
      await tester.pumpWidget(
        createWidgetForTesting(
          child: GlassTile(borderRadius: borderRadius, child: const SizedBox()),
        ),
      );
    ...
    testWidgets('should use PremiumStyle colors in dark mode', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        ScreenUtilInit(
          ...
          builder: (context, _) => MaterialApp(
            ...
            home: const Scaffold(
              body: GlassTile(usePremiumStyle: true, child: SizedBox()),
            ),
          ),
        ),
      );
