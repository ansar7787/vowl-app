...
void main() {
  final file = File('lib/features/speaking/pronunciation_focus/presentation/pages/pronunciation_focus_screen.dart');
  String content = file.readAsStringSync();
  content = content.replaceAll('\r\n', '\n');

  // Variables
  content = content.replaceAll('double _heatLevel = 0.0;', 'final ValueNotifier<double> _heatLevel = ValueNotifier(0.0);');
  ...
  content = content.replaceAll('bool _showGuide = false;', 'final ValueNotifier<bool> _showGuide = ValueNotifier(false);');
  ...
  // Logic
  content = content.replaceAll('''    _tickerController =
  ...
  // Widget properties
  content = content.replaceAll('''                                heatLevel: _heatLevel,
  ...
  content = content.replaceAll('''                                heatLevel: _heatLevel,
                                isListening: false,
                                timeVal: _timeVal,''', '''                                heatLevel: _heatLevel.value,
                                isListening: false,
