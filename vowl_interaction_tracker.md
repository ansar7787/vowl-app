...
- [ ] 1. Grammar Quest (Action: Implement **Dynamic Jigsaw** - rebuild the full sentence)
- [ ] 2. Sentence Correction (Action: Verify Type-to-confirm is active)
- [ ] 3. Word Reorder (Action: Verify Reorder is active)
- [ ] 4. Tense Mastery (Action: Implement **Dynamic Anagram** - spell the verb tense)
- [ ] 5. Parts of Speech (Action: Implement **Dynamic Jigsaw**)
- [ ] 6. Subject-Verb Agreement (Action: Implement **Dynamic Jigsaw**)
- [ ] 7. Clause Connector (Action: Implement **Dynamic Jigsaw** - place the connector)
- [ ] 8. Voice Swap (Action: Verify Type-to-confirm is active)
- [ ] 9. Question Formatter (Action: Implement **Dynamic Jigsaw**)
- [ ] 10. Article Insertion (Action: Implement **Dynamic Jigsaw**)
- [ ] 11. Modifier Placement (Action: Implement **Dynamic Jigsaw**)
- [ ] 12. Modals Selection (Action: Implement **Dynamic Jigsaw**)
- [ ] 13. Preposition Choice (Action: Implement **Dynamic Jigsaw**)
- [ ] 14. Pronoun Resolution (Action: Implement **Dynamic Jigsaw**)
- [ ] 15. Punctuation Mastery (Action: Implement `TypeToConfirmOverlay` - punctuation requires typing)
- [ ] 16. Relative Clauses (Action: Implement **Dynamic Jigsaw**)
- [ ] 17. Conditionals (Action: Verify Type-to-confirm is active)
- [ ] 18. Conjunctions (Action: Implement **Dynamic Jigsaw**)
- [ ] 19. Direct/Indirect Speech (Action: Verify Type-to-confirm is active)
...
- [ ] 4. Scene Description (Action: Verify Voice + Radar)
- [ ] 5. Yes/No Speaking (Action: Verify Voice + Tilt)
- [ ] 6. Speak Synonym (Action: Verify Voice + Watering)
- [ ] 7. Dialogue Roleplay (Action: Verify Voice)
- [ ] 8. Pronunciation Focus (Action: Verify Voice + Highlight)
- [ ] 9. Speak Opposite (Action: Verify Voice + EM trigger)
- [ ] 10. Daily Expression (Action: Verify Voice + Scratch)

## 7. ACCENT (12 Games)
*Goal: Ensure audio recording and playback is flawless.*
- [ ] 1. Minimal Pairs (Action: Verify Voice + Listen)
- [ ] 2. Intonation Mimic (Action: Verify Voice)
- [ ] 3. Syllable Stress (Action: Verify Tap + Listen)
- [ ] 4. Word Linking (Action: Verify Gesture + Link)
- [ ] 5. Shadowing Challenge (Action: Verify Voice)
- [ ] 6. Vowel Distinction (Action: Verify Voice + Listen)
- [ ] 7. Consonant Clarity (Action: Verify Voice + Listen)
- [ ] 8. Pitch Pattern Match (Action: Verify Listen + Match)
- [ ] 9. Speed Variance (Action: Verify Listen + Adjust)
- [ ] 10. Dialect Drill (Action: Verify Listen + Choose)
- [ ] 11. Connected Speech (Action: Verify Voice + Listen)
- [ ] 12. Pitch Modulation (Action: Verify Voice)
