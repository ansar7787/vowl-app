...
- [x] 1. Alphabet (Action: Implement Tap + Auto TTS Playback)
- [x] 2. Numbers (Action: Implement Tap + Auto TTS Playback)
- [x] 3. Colors (Action: Implement Tap + Auto TTS Playback)
- [x] 4. Shapes (Action: Implement Tap + Auto TTS Playback)
- [x] 5. Animals (Action: Implement Tap + Auto TTS Playback)
- [x] 6. Fruits (Action: Implement Tap + Auto TTS Playback)
- [x] 7. Family (Action: Implement Tap + Auto TTS Playback)
- [x] 8. School (Action: Implement Tap + Auto TTS Playback)
- [x] 9. Verbs (Action: Implement Tap + Auto TTS Playback)
- [x] 10. Routine (Action: Implement Tap + Auto TTS Playback)
- [x] 11. Emotions (Action: Implement Tap + Auto TTS Playback)
- [x] 12. Prepositions (Action: Implement Tap + Auto TTS Playback)
- [x] 13. Phonics (Action: Implement Tap + Auto TTS Playback)
- [x] 14. Time (Action: Implement Tap + Auto TTS Playback)
- [x] 15. Opposites (Action: Implement Tap + Auto TTS Playback)
- [x] 16. Day/Night (Action: Implement Tap + Auto TTS Playback)
- [x] 17. Nature (Action: Implement Tap + Auto TTS Playback)
- [x] 18. Home (Action: Implement Tap + Auto TTS Playback)
- [x] 19. Food (Action: Implement Tap + Auto TTS Playback)
- [x] 20. Transport (Action: Implement Tap + Auto TTS Playback)
- [x] 21. Body Parts (Action: Implement Tap + Auto TTS Playback)
- [x] 22. Clothing (Action: Implement Tap + Auto TTS Playback)
- [x] 23. Handwriting (Action: Verify Canvas-based drawing)
- [x] 24. Weather (Action: Implement Tap + Auto TTS Playback)
- [x] 25. Professions (Action: Implement Tap + Auto TTS Playback)
