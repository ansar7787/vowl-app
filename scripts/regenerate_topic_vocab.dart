...
void main() {
  final List<Map<String, dynamic>> categoryPool = [
    ...
    {
      "buckets": ["String Instruments", "Wind Instruments"],
      "options": [
        [
          "Cello",
          "Violin",
    ...
    {
      "buckets": ["Warm Colors", "Cool Colors"],
      "options": [
        [
          "Crimson",
          "Amber",
    ...
    {
      "buckets": ["Indoor Sports", "Outdoor Sports"],
      "options": [
        [
          "Badminton",
          "Bowling",
    ...
    {
      "buckets": ["Inner Planets", "Outer Planets"],
      "options": [
        ["Mercury", "Venus", "Mars", "Earth"],
        ["Jupiter", "Saturn", "Neptune", "Uranus", "Pluto (Dwarf)"],
      ],
    },
    {
      "buckets": ["Kitchen Tools", "Office Supplies"],
      "options": [
        [
          "Whisk",
          "Spatula",
    ...
    {
      "buckets": ["Land Transport", "Air Transport"],
      "options": [
        [
          "Locomotive",
          "Scooter",
    ...
    {
      "buckets": ["Summer Clothing", "Winter Clothing"],
      "options": [
        [
          "Sandals",
          "Swimsuit",
    ...
    {
      "buckets": ["Positive Emotions", "Negative Emotions"],
      "options": [
        [
          "Euphoria",
          "Serenity",
    ...
    {
      "buckets": ["Natural Materials", "Synthetic Materials"],
      "options": [
        [
          "Marble",
          "Wool",
    ...
    {
      "buckets": ["Medical Jobs", "Creative Jobs"],
      "options": [
        [
          "Surgeon",
          "Pharmacist",
    ...
    {
      "buckets": ["European Countries", "Asian Countries"],
      "options": [
        [
          "Finland",
          "Greece",
    ...
    {
      "buckets": ["Time Units", "Length Units"],
      "options": [
        [
          "Decade",
          "Century",
    ...
    {
      "buckets": ["Precious Metals", "Gemstones"],
      "options": [
        [
          "Platinum",
          "Palladium",
    ...
    {
      "buckets": ["Ancient History", "Modern History"],
      "options": [
        [
          "Pharaoh",
          "Gladiator",
    ...
    {
      "buckets": ["Mythology", "Science Fiction"],
      "options": [
        [
          "Centaur",
          "Phoenix",
    ...
    {
      "buckets": ["Musical Genres", "Art Styles"],
      "options": [
        [
          "Jazz",
          "Reggae",
    ...
    for (int level = startLevel; level <= endLevel; level++) {
      for (int qNum = 1; qNum <= 3; qNum++) {
        ...
        while (selectedQuest == null) {
          ...
          selectedItems.sort();
          final uniquenessKey =
              "${buckets.join(',')}|${selectedItems.join(',')}";
